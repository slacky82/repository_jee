...
import it.nerdexception.crudprime.util.JsfUtil;
import it.nerdexception.crudprime.util.JsfUtil.PersistAction;
...
public class EmployeeController implements Serializable {
    ...
    @EJB
    private it.nerdexception.crudprime.EmployeeFacade ejbFacade;
